...
const projects: Project[] = [
  ...
  },
  {
    ...
    tag: "E-Commerce",
    description: "Next-gen headless commerce architecture. Sub-second checkout flows, personalized product journeys, and 45% lift in checkout conversion.",
    image: "/images/device_mockup_clean.png",
    link: "#case-velo",
  },
  {
    num: "04",
    title: "MediTrack Mobile AI",
    category: "Mobile Apps",
    tag: "Mobile Apps",
    description: "Intelligent telemetry and patient care mobile application. Built with high-fidelity micro-interactions and cross-platform native performance.",
    image: "/projects/meditrack.png",
    link: "#case-meditrack",
  },
  {
    num: "05",
    title: "Vista Growth Engine",
    category: "Dashboards",
    tag: "Dashboards",
    description: "Multi-layered analytics board translating deep customer acquisition funnels into clean, actionable business decisions.",
  ...
  },
  {
    ...
    tag: "Web Design",
    description: "Next-gen modular design systems. Scalable UI component tokens, design primitives, and unified digital brand authority.",
